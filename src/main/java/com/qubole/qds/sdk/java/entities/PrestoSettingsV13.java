...
public class PrestoSettingsV13
{
    private boolean enable_presto;
    private String custom_config;
    private String jvm_config;

    public PrestoSettingsV13()
    {
    }

    public PrestoSettingsV13(boolean enable_presto, String custom_config, String jvm_config)
    {
        this.enable_presto = enable_presto;
        this.custom_config = custom_config;
        this.jvm_config = jvm_config;
    }
    ...
    public String getJvm_config()
    {
        return jvm_config;
    }

    public void setJvm_config(String jvm_config)
    {
        this.jvm_config = jvm_config;
    }
}
