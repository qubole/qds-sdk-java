...
public class StableSpotInstanceSettingsV13
{
    private String maximum_bid_price_percentage;
    private int timeout_for_request;

    public StableSpotInstanceSettingsV13()
    {
    }

    public StableSpotInstanceSettingsV13(String maximum_bid_price_percentage, int timeout_for_request)
    {
