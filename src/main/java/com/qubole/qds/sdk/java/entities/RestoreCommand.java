...
public class RestoreCommand 
{
    ...
    RestoreCommand(Restore parameters, String action, String cluster_inst_id, String private_dns)
    {
    ...
    public Restore getParameters()
    {
        return parameters;
    }

    public void setParameters(Restore parameters)
    {
        this.parameters = parameters;
    }
