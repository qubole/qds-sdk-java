...
public class SpotInstanceSettingsV13
{
    ...
    public SpotInstanceSettingsV13(String maximum_bid_price_percentage, int timeout_for_request, int maximum_spot_instance_percentage)
    {
