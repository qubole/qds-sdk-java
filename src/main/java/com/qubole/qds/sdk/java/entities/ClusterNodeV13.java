...
public class ClusterNodeV13
{
    ...
    public ClusterNodeV13()
    {
    }

    public ClusterNodeV13(String status, String instance_type, String ec2_instance_id, boolean is_spot_instance, String up_time, String private_ip, String last_seen_time, String role, String down_time, String hostname)
    {
        this.status = status;
