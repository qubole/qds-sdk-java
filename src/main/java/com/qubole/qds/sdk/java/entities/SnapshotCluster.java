...
public class SnapshotCluster 
{
    ...
    public SnapshotCommand getCommand()
    {
        return command;
    }

    public void setCommand(SnapshotCommand command)
    {
        this.command = command;
    }
